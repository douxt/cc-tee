  ...
  case "$PROFILE" in
    direct)
      if [ "$DIRECT_PROVIDER" = "qwen" ]; then
        V_T='[{"name":"ANTHROPIC_BASE_URL","value":"https://dashscope.aliyuncs.com/apps/anthropic"},{"name":"ANTHROPIC_AUTH_TOKEN","value":"__DASHSCOPE_API_KEY__"},{"name":"ANTHROPIC_MODEL","value":"qwen3.7-plus[1m]"},{"name":"ANTHROPIC_DEFAULT_HAIKU_MODEL","value":"qwen3.7-flash[1m]"},{"name":"ANTHROPIC_DEFAULT_SONNET_MODEL","value":"qwen3.7-plus[1m]"},{"name":"ANTHROPIC_DEFAULT_OPUS_MODEL","value":"qwen3.7-max[1m]"},{"name":"CLAUDE_CODE_SUBAGENT_MODEL","value":"qwen3.7-flash[1m]"},{"name":"CLAUDE_CODE_EFFORT_LEVEL","value":"max"},{"name":"CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC","value":"1"}]'
      else
...
case "$PROFILE" in
    direct)
      if [ "$DIRECT_PROVIDER" = "qwen" ]; then
        W_T='{"ANTHROPIC_BASE_URL":"https://dashscope.aliyuncs.com/apps/anthropic","ANTHROPIC_AUTH_TOKEN":"__DASHSCOPE_API_KEY__","ANTHROPIC_MODEL":"qwen3.7-plus[1m]","ANTHROPIC_DEFAULT_HAIKU_MODEL":"qwen3.7-flash[1m]","ANTHROPIC_DEFAULT_SONNET_MODEL":"qwen3.7-plus[1m]","ANTHROPIC_DEFAULT_OPUS_MODEL":"qwen3.7-max[1m]","CLAUDE_CODE_SUBAGENT_MODEL":"qwen3.7-flash[1m]","CLAUDE_CODE_EFFORT_LEVEL":"max","CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC":"1"}'
      else
